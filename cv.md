...
<head>
    ...
    <title> SV</title>
    <link rel="icon" href="img/gol.ico">
</head>
<body>
<div class="page">
<!------------------ Header -------------------------------------------------->
        ...
        <li class="nav-item">
            <a class="nav-link" href="index.html#languages">Languages</a>
        </li>
        <li class="nav-item">
    ...
    <div class="container">
        <main class="content">
            ...
            <div class="pro">
            <img class="img intro-img" src="./img/avatar.jpg" alt="">
        </div>
...
<div class="section-container">
 ...
 <p>
       I work in the telecommunications industry.Programming always captures me, now I see myself in this direction.I'm just gaining momentum and striving to win.
 </p>
</div>
</section>
...
<p>  2024</p>
<a href="https://rs.school/courses/javascript-ru"><img src="./img/rss-logo1.svg" width="50" height="50" alt="logo"></a>
</div>
</footer>
</div><!-- page -->
</body>
